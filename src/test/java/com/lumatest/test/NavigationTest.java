...
//        getDriver().get(baseURL);
//
//        getWait5().until(ExpectedConditions.visibilityOf(getDriver().findElement(TestData.WOMEN_MENU)));
...
//        getDriver().get(baseURL);
//
//        getWait5().until(ExpectedConditions.visibilityOf(getDriver().findElement(TestData.MEN_MENU)));
...
//    @Severity(SeverityLevel.CRITICAL)
//    @Link(TestData.BASE_URL)
//    public void testNavigationMenMenuTops(String baseURL, By webElement, String expectedURL, String expectedTitle) throws InterruptedException {
//
//        Allure.step("Open Base URL");
//        getDriver().get(baseURL);
//
...
//        getDriver().get(baseURL);
//
//        getWait5().until(ExpectedConditions.visibilityOf(getDriver().findElement(TestData.GEAR_MENU)));
...
//        getDriver().get(TestData.BASE_URL);
//
//        getWait5().until(ExpectedConditions.visibilityOf(getDriver().findElement(TestData.TRAINING_MENU)));
